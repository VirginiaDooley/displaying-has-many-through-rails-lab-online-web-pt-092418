...
describe 'Patient' do
  ...
  before do
    ...
    @appointment1 = Appointment.create(appointment_datetime: DateTime.new(2016, 10, 1), doctor_id: @mcdreamy, patient_id: @patient  )
    @appointment2 = Appointment.create(appointment_datetime: DateTime.new(2016, 10, 1), doctor_id: @meredith, patient_id: @patient  )
  end
